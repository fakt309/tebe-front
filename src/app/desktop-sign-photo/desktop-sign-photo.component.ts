import { Component, OnInit, EventEmitter, Input, Output, SimpleChanges, ElementRef, HostListener } from '@angular/core'
import { Touch2Service, Touch } from '../services/touch2.service'
import { GetTargetHtmlService } from '../services/get-target-html.service'

@Component({
  selector: 'app-desktop-sign-photo',
  templateUrl: './desktop-sign-photo.component.html',
  styleUrls: ['./desktop-sign-photo.component.scss']
})
export class DesktopSignPhotoComponent implements OnInit {
